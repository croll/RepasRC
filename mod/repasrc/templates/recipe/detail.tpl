	...
	<div style="font-size: 14px">
		...
		<div>Saisonnalité: <span></span></div>
			<div class="btn-group">
					...
					<span class="btn">Mar</span>
					<span class="btn">Avr</span>
					<span class="btn btn-info">Mai</span>
					<span class="btn btn-info">Jui</span>
					<span class="btn btn-info">Jui</span>
					<span class="btn btn-info">Aou</span>
					<span class="btn btn-info">Sep</span>
